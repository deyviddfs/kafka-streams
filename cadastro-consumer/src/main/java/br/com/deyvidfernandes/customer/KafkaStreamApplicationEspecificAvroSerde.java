...
public class KafkaStreamApplicationEspecificAvroSerde {
	...
	public static void main(String[] args) {
		...
		KStream<String, Customer> kStream = streamsBuilder.stream("STREAMS.CUSTOMER.TEST2", Consumed.with(Serdes.String(), valueSpecificAvroSerde));
